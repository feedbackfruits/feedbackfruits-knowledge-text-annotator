...
const captions_to_text_1 = require("./captions-to-text");
...
function annotateVideo(doc) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const sdi = create_index_1.createIndex(doc);
        const mappedAnnotations = doc[Engine.Context.iris.$.annotation].map(annotation => {
            const id = annotation["@id"];
            const startDuration = sdi[id];
            return Object.assign({}, annotation, { "@type": [].concat(annotate["@type"], "VideoAnnotation"), [Engine.Context.iris.$.startDuration]: startDuration });
        });
        return annotated;
    });
}
...
function annotateDocument(doc) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const response = yield node_fetch_1.default(textUrl);
...
function docToText(doc) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const captionText = yield captions_to_text_1.default(url);
        return captionText;
    });
}
