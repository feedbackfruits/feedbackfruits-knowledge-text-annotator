...
function isWebPageResource(doc) {
    return [].concat(doc["@type"]).indexOf(Engine.Context.iris.$.WebPageResource) != -1;
}
exports.isWebPageResource = isWebPageResource;
...
function annotateWebPageResource(doc) {
    return __awaiter(this, void 0, void 0, function* () {
        const url = doc["@id"];
        console.log('Retrieving information for url:', url);
        const { concepts, namedEntities } = yield retrieveInformation({ url });
        const tags = conceptsToTags(concepts, doc["@id"]);
        const annotations = namedEntitiesToAnnotations(namedEntities, doc["@id"]);
        const annotated = Object.assign({}, doc, { [Engine.Context.iris.$.tag]: tags, [Engine.Context.iris.$.annotation]: annotations });
        const expanded = yield Engine.Doc.expand(annotated, Engine.Context.context);
...
exports.annotateWebPageResource = annotateWebPageResource;
...
function annotateDocument(doc) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const withMappedAnnotations = Object.assign({}, annotated, { [Engine.Context.iris.schema.name]: title, [Engine.Context.iris.$.annotation]: mappedAnnotations });
        return withMappedAnnotations;
    });
}
...
function retrieveInformation(options) {
    return __awaiter(this, void 0, void 0, function* () {
        let response;
        if ('text' in options) {
            response = yield node_fetch_1.default(`${config_1.RETRIEVE_URL}/text?concepts&namedEntities`, {
                method: 'post',
                headers: {
        ...
        if ('url' in options) {
            response = yield node_fetch_1.default(`${config_1.RETRIEVE_URL}/url?concepts&namedEntities`, {
                method: 'post',
                headers: {
                    'Content-type': 'text/plain'
                },
