...
function annotate(doc) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const concepts = yield helpers_1.textToConcepts([].concat(doc[feedbackfruits_knowledge_engine_1.Helpers.decodeIRI(Context.graph.schema.text)])[0]);
        if (concepts.length === 0)
            return doc;
        return Object.assign({}, doc, { [feedbackfruits_knowledge_engine_1.Helpers.decodeIRI(Context.graph.schema.about)]: concepts });
    });
}
function init({ name }) {
    return __awaiter(this, void 0, void 0, function* () {
